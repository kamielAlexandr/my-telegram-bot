...
# Добавляем эту строку в конец файла для совместимости
__all__ = ['init_db', 'create_character', 'get_character', 'get_all_races', 
           'update_character_stats', 'add_experience', 'add_gold', 'log_battle']
