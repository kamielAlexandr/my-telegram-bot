...
DONATE_PACKAGES = {
    'pack_mini': {'name': '🪙 Горсть монет (1,000g)', 'gold': 1000, 'price': 10},     # Базовый курс
    'pack1': {'name': '💰 Кошель золота (5,500g)', 'gold': 5500, 'price': 50},        # Выгода +10%
    'pack2': {'name': '📦 Тяжелый сундук (18,000g)', 'gold': 18000, 'price': 150},    # Выгода +20%
    'pack3': {'name': '👑 Имперская казна (50,000g)', 'gold': 50000, 'price': 350}    # Выгода +40%
}
